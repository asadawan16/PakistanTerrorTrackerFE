    ...
    <div className="border border-gray-800 rounded-2xl p-6" style={{ backgroundColor: '#262626' }}>
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-xs mt-1" style={{ color: '#9CA3AF' }}>Attack distribution</p>
        </div>
      </div>
      ...
      <div className="h-80 relative">
          ...
          <PieChart>
            <defs>
              {chartData.map((entry, index) => (
                <linearGradient key={`grad-r-${index}`} id={`grad-r-${index}`} x1="0" y1="0" x2="1" y2="1">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
          ...
          <div className="text-xs" style={{ color: '#9CA3AF' }}>Total attacks</div>
        </div>
      </div>
